...
CCFLAGS = -m64 -std=gnu11 -g -ffreestanding -Wall -Wextra -nostdlib -Ibootloader/ -Isource/ -fno-stack-protector -Wno-unused-parameter -fno-stack-check -fno-lto -mno-red-zone
